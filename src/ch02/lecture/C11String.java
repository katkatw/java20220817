...
//		k.charAt(3); //indexOutOfBoundsException 던져짐(발생)
		...
		System.out.println(r.charAt(r.length()-1)); // 왜 이렇게 나오는지 더 해봐야함
		
		// substring
		
		String s = r.substring(0);  //int로 쓸 수 있는 정수는 다 넣을 수는 있으나 (문법에 맞지만) 음수는 throw한다
		...
		System.out.println(r.substring(10)); // n번째부터 프린트
